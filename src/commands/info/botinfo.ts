...
export default class BotInfo implements Command {
    ...
    aliases = ["info", "about"];
    category = "info";
    description = "Displays information about TundraBot.";
    usage = "botinfo";
    enabled = true;
    ...
    slashDescription = "Displays information about TundraBot";
    commandOptions = [];
    ...
    async execute(ctx: CommandContext, args: string[]): Promise<void> {
        ...
        const embedMsg = new MessageEmbed()
            ...
            .addField("Server count", ctx.client.guilds.cache.size.toString())
