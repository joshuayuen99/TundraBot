...
export default class SpellCast implements Command {
    name = "spellcast";
    category = "fun";
    description = "Starts a new Spell Cast game for the current voice channel.";
    usage = "spellcast";
    enabled = true;
    ...
    slashDescription = "Start a new Spell Cast game for the current voice channel";
    commandOptions = [];
    ...
    async execute(ctx: CommandContext, args: string[]): Promise<void> {
        ...
        ctx.client.discordTogether
            .createTogetherCode(voice.id, "spellcast")
            .then(async (invite) => {
