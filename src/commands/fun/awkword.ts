...
export default class Awkword implements Command {
    name = "awkword";
    category = "fun";
    description = "Starts a new Awkword game for the current voice channel.";
    usage = "awkword";
    enabled = true;
    ...
    slashDescription = "Start a new Awkword game for the current voice channel";
    commandOptions = [];
    ...
    async execute(ctx: CommandContext, args: string[]): Promise<void> {
        ...
        ctx.client.discordTogether
            .createTogetherCode(voice.id, "awkword")
            .then(async (invite) => {
