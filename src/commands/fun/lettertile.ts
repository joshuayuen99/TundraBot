...
export default class LetterTile implements Command {
    name = "lettertile";
    category = "fun";
    description = "Starts a new Letter Tile game for the current voice channel.";
    usage = "lettertile";
    enabled = true;
    ...
    slashDescription = "Start a new Letter Tile game for the current voice channel";
    commandOptions = [];
    ...
    async execute(ctx: CommandContext, args: string[]): Promise<void> {
        ...
        ctx.client.discordTogether
            .createTogetherCode(voice.id, "lettertile")
            .then(async (invite) => {
