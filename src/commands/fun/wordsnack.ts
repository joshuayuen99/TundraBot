...
export default class WordSnack implements Command {
    name = "wordsnack";
    category = "fun";
    description = "Starts a new Word Snack game for the current voice channel.";
    usage = "wordsnack";
    enabled = true;
    ...
    slashDescription = "Start a new Word Snack game for the current voice channel";
    commandOptions = [];
    ...
    async execute(ctx: CommandContext, args: string[]): Promise<void> {
        ...
        ctx.client.discordTogether
            .createTogetherCode(voice.id, "wordsnack")
            .then(async (invite) => {
