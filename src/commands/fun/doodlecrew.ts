...
export default class DoodleCrew implements Command {
    name = "doodlecrew";
    category = "fun";
    description = "Starts a new Doodle Crew game for the current voice channel.";
    usage = "doodlecrew";
    enabled = true;
    ...
    slashDescription = "Start a new Doodle Crew game for the current voice channel";
    commandOptions = [];
    ...
    async execute(ctx: CommandContext, args: string[]): Promise<void> {
        ...
        ctx.client.discordTogether
            .createTogetherCode(voice.id, "doodlecrew")
            .then(async (invite) => {
