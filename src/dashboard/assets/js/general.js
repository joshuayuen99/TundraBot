...
$("input#prefix").on("input", function() {
    ...
    $("button#generalSubmitButton").attr("disabled", !$("button#generalSubmitButton").closest("form")[0].checkValidity());
});
...
$("#welcomeMessageCheckbox").change(function() {
    if ($(this).prop("checked")) { // checked
        ...
        // check if submit button should be clickable
        $("button#generalSubmitButton").attr("disabled", !$("form")[0].checkValidity());
    } else { // unchecked
...
$("#joinMessagesCheckbox").change(function() {
    if ($(this).prop("checked")) { // checked
        ...
        $("#joinMessagesTrackInvitesCheckbox").prop("disabled", false);
    } else { // unchecked
        ...
        $("#joinMessagesTrackInvitesCheckbox").prop("disabled", true);
    }
